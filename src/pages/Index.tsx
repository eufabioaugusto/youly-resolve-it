...
const logos = [
  ...
  "https://upload.wikimedia.org/wikipedia/commons/c/c4/Casas_Bahia_logo_%282015%29.svg",
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    let x = 0;
    const speed = 0.3; // ajuste fino de velocidade
        ...
        <div className="container mx-auto px-4">
          <div className="rounded-2xl bg-gradient-to-r from-[#ea8375] to-[#ff2b35] p-6 md:p-10 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <img
                  src="/images/hero-youly-garantia.png"
                  alt="Montador profissional"
                  className="w-full object-cover"
                  loading="eager"
                  referrerPolicy="no-referrer"
