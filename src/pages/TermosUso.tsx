          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                Ao acessar e usar a plataforma Youly, você concorda em cumprir e estar vinculado aos seguintes 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                A Youly é uma plataforma digital que conecta clientes que necessitam de serviços de montagem 
                e instalação de móveis com profissionais montadores qualificados. A Youly atua como intermediária, 
                facilitando a conexão entre as partes.
              </p>
              <p className="text-muted-foreground">
                <strong>Importante:</strong> A Youly não é prestadora direta dos serviços de montagem. 
                Os montadores são profissionais autônomos responsáveis pela execução dos serviços contratados.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                imediatamente a Youly sobre qualquer uso não autorizado.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Todos os pagamentos devem ser processados exclusivamente através da plataforma Youly. 
                Pagamentos diretos entre clientes e montadores são proibidos e podem resultar no 
                banimento da plataforma.
              </p>

              <h3 className="text-xl font-semibold mb-3">5.2 Taxa de Serviço</h3>
              <p className="text-muted-foreground mb-4">
                A Youly cobra uma comissão de 15% sobre o valor de cada serviço concluído. 
                Esta taxa cobre processamento de pagamentos, suporte, garantia e manutenção da plataforma.
              </p>

              <h3 className="text-xl font-semibold mb-3">5.3 Reembolsos</h3>
              <p className="text-muted-foreground">
                Reembolsos são processados em casos de não comparecimento injustificado do montador 
                ou cancelamento antes da confirmação do serviço, conforme nossa política de cancelamento.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Todos os serviços realizados através da Youly possuem garantia de 90 dias para defeitos 
                de montagem. O montador é obrigado a retornar e corrigir problemas decorrentes de sua execução 
                sem custo adicional ao cliente.
              </p>
              <p className="text-muted-foreground">
                A garantia não cobre defeitos de fábrica, danos causados por uso inadequado ou 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                A Youly atua como intermediária e não é responsável pela qualidade, segurança ou legalidade 
                dos serviços prestados pelos montadores. Não garantimos que os serviços atendam às suas expectativas 
                ou que os montadores cumpram todas as obrigações.
              </p>

              <h3 className="text-xl font-semibold mb-3">8.2 Isenção de Garantias</h3>
              <p className="text-muted-foreground">
                A plataforma é fornecida "como está" e "conforme disponível". Não garantimos operação 
                ininterrupta, livre de erros ou vírus.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Todo o conteúdo da plataforma Youly, incluindo textos, gráficos, logos, ícones, imagens e software, 
                é propriedade da Youly ou de seus licenciadores e está protegido por leis de direitos autorais.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                A Youly reserva-se o direito de modificar estes termos a qualquer momento. 
                Notificaremos os usuários sobre mudanças significativas. O uso continuado da plataforma 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                A Youly pode suspender ou encerrar sua conta a qualquer momento, com ou sem aviso prévio, 
                por violação destes termos ou por conduta prejudicial à plataforma ou outros usuários.
              </p>
            </section>
