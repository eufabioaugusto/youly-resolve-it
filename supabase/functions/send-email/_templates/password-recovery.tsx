...
export const PasswordRecoveryEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Recuperação de senha - YOULY</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Olá! Recebemos uma solicitação para redefinir sua senha no YOULY.
          </Text>
          ...
          <Text style={smallText}>
            Ou copie e cole este código de recuperação temporário:
          </Text>
